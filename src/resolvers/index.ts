import { STUDENTS_QUERY, Student } from './queries/students';
import { SUBJECTS_QUERY, Subject } from './queries/subjects';
...
export type STUDENTS_QUERY_INPUT_OUTPUT_SHAPE = STUDENTS_QUERY;
export type StudentGraphQL = Student;
export type SUBJECTS_QUERY_INPUT_OUTPUT_SHAPE = SUBJECTS_QUERY;
